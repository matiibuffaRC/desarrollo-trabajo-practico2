    ...
    return (
        <div className='shadow-md rounded-3xl bg-linear-to-l from-[#AFACF4] to-[#F3EDEB] flex flex-col justify-center items-center px-5 py-3'>
            <div className='flex flex-row justify-between items-center w-full'>
                ...
                <button onClick={onAddClick} className="h-7 w-7 bg-white rounded-full flex items-center justify-center shadow hover:bg-gray-100 active:scale-95 transition" >
